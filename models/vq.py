...
def get_model(lat_dim, use_timestep=False):
    yaml_path = 'models/configs/vqgan.yaml'
    ...
    return VQModel(ddconfig, embed_dim, lat_dim, use_timestep)

class VQModel(nn.Module):
    def __init__(self, ddconfig, embed_dim, lat_dim=256, use_timestep=False):
        super().__init__()
        # make encoder and decoder
        self.encoder = Encoder(**ddconfig, use_timestep=use_timestep)
        self.decoder = Decoder(**ddconfig, use_timestep=use_timestep)
...
class Encoder(nn.Module):
    def __init__(self, *, ch, out_ch, ch_mult=(1,2,4,8), num_res_blocks,
                 ...
                 resolution, z_channels, double_z=True, use_timestep, **ignore_kwargs):
        super().__init__()
        self.ch = ch
...
class Decoder(nn.Module):
    def __init__(self, *, ch, out_ch, ch_mult=(1,2,4,8), num_res_blocks,
                 attn_resolutions, dropout=0.0, resamp_with_conv=True, in_channels,
                 resolution, z_channels, give_pre_end=False, use_timestep, **ignorekwargs):
        super().__init__()
        self.ch = ch
